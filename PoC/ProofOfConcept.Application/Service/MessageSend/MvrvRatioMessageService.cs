...
{
    public class MvrvRatioMessageService : IMessageSenderService<MvrvRatio>
    {
        private readonly IMessageApiService _messageApiService;
        private Dictionary<string, string> _codeMessageDictionary = new Dictionary<string, string>();

        public MvrvRatioMessageService(IMessageApiService messageApiService)
        {
        ...
        public Task SendEventMessageAsync(ZoneChageEvent<MvrvRatio> data)
        {
        ...
        public Task SendNotificationAsync(MvrvRatio notification)
        {
            throw new System.NotImplementedException();
        }
    }
